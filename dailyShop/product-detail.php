...
if(isset($_GET['quick_view']))
{
  ...
  $product=array();
  $product_array=array();
  $id_to_view=$_GET['prod_id'];
  //echo $id_to_view;
  $product=showQuickView($id_to_view);
  //print_r($product);
}
     ...
     <div class="container">
      <div class="aa-catg-head-banner-content">
        ...
        <ol class="breadcrumb">
          ...
          <li class="active"><?php echo $product[$key]['name'];?></li>
        </ol>
      </div>
     </div>
   </div>
              ...
              <div class="row">
                  ...
                  <div class="aa-product-view-slider">                                
                    <div id="demo-1" class="simpleLens-gallery-container">
                      <div class="simpleLens-container">
                        <div class="simpleLens-big-image-container"><a data-lens-image="img/view-slider/large/polo-shirt-1.png" class="simpleLens-lens-image"><img src="../uploadsnew/<?php echo $product[$key]['image'];?>" class="simpleLens-big-image"></a></div>
                      </div>
                ...
                <div class="col-md-7 col-sm-7 col-xs-12">
                  <div class="aa-product-view-content">
                    <h3><?php echo $product[$key]['name'];?></h3>
                    <div class="aa-price-block">
                      <span class="aa-product-view-price"><?php echo $product[$key]['price'];?></span>
                    ...
                    <div class="aa-prod-quantity">
                      ...
                      <p class="aa-prod-category">
                        Category: <a href="#"><?php echo $product[$key]['category'];?></a>
                      </p>
                    </div>
