			...
			<div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-header">
					...
					<ul class="content-box-tabs">
						<li><a href="#tab1" class="default-tab" id="showtable">Product Table</a></li> <!-- href must be unique and match the id of target div -->
						<li><a href="#tab2" id="adding">Add Product</a></li>
					</ul>
