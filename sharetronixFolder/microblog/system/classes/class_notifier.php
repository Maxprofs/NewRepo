<?php
	class notifier
	{
		...
		{ 
			...
			$represendHtml = '';
			if( $this->comment ){
				$represendTxt = $this->comment->represent_comment_in_email(false);
				$represendHtml = $this->comment->represent_comment_in_email();
			}elseif( $this->post ){
				$represendTxt = $this->post->represent_post_in_email(false);
				$represendHtml = $this->post->represent_post_in_email();
			}
			...
			$msgtxt		= $this->page->load_template('email/notifications_txt.php', FALSE);
			$msghtml		= $this->page->load_template('email/notifications_html.php', FALSE);
