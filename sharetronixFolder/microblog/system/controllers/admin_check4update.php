<?php
	...
	$url	= 'http://www.developer.sharetronix.com/versioncheck/?version='.urlencode($C->VERSION).'&site='.urlencode($C->SITE_URL).'&lang='.urlencode($C->LANGUAGE).'&type='.urlencode('personal');
