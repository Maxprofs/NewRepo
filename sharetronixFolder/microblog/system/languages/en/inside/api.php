<?php
	...
	(
		...
		'api_app_web_err'		=> 'Please, provide valid website for your application.',
		...
		'api_app_desc'	=> 'Description:',
		'api_app_web'	=> 'Application Website:',
		'api_app_web_msg'	=> 'Where\'s your application\'s home page, where users can go to download or use it?',
		'api_app_org'	=> 'Organization:',
		'api_app_comp_web'	=> 'Website:',
		'api_app_comp_web_msg'	=> 'The home page of your company or organization.',
		'api_app_type'	=> 'Application Type:',
		'api_app_type_c'	=> 'Client',
		'api_app_type_b'	=> 'Browser',
		'api_app_type_msg'	=> 'Does your application run in a Web Browser or a Desktop Client?',
		'api_app_type_b_msg'	=> 'Browser uses a Callback URL to return to your App after successfully authentication.',
		'api_app_type_c_msg'	=> 'Client prompts your user to return to your application after approving access.',
		'api_app_callback'	=> 'Callback URL:',
		'api_app_callback_msg'	=> 'Where should we return to after successfully authentication?',
		'api_app_acc_type'	=> 'Default Access type:',
		'api_app_date_reg'	=> 'Date Of Registration:',
		'api_app_ip_reg'	=> 'Registered From IP:',
		'api_app_c_key'	=> 'Consumer key:',
		'api_app_del_msg2'	=> 'Delete this application',
		'api_app_c_secret'	=> 'Consumer secret:',
		'api_app_acc_rw'	=> 'Read & Write',
		'api_app_acc_r'	=> 'Read-Only',
		'api_app_acc_msg'	=> 'What type of access does your application need?',
