...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en-US">
	<head>
		...
		<link href="<?= $C->OUTSIDE_SITE_URL ?>themes/facebookish/css/mobile_iphone.css" media="handheld" rel="stylesheet" type="text/css" />
		<link href="<?= $C->OUTSIDE_SITE_URL ?>themes/facebookish/css/mobile_iphone.css" media="screen" rel="stylesheet" type="text/css" />
		...
		<link href="<?= $C->OUTSIDE_SITE_URL ?>themes/facebookish/imgs/favicon.ico" type="image/x-icon" rel="shortcut icon" />
