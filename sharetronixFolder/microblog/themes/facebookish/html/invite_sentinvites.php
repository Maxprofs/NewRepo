					...
					<div class="greygrad3" style="padding-bottom:0px;">
						<table width="100%" id="invtable">
							<tr>
								...
								<td style="text-align: center;"><b><?= $this->lang('inv_tabl_send_again') ?></b>
							</tr>
							<tr><td style="padding:0px; height:1px; background-color:#ccc;" colspan="5"></td></tr>
							<tr>
							<?php foreach($D->invites as $obj) { ?>
								...
								<td style="text-align: center;"><?= ($obj->resend)? '<a href="'.$C->SITE_URL.'invite/sentinvites?resend_to='.urlencode($obj->email).'"> '.$this->lang('inv_td_send_again').' </a>':(($obj->is_accepted)? '':$this->lang('inv_td_send_again_err')) ?> </td>
							</tr>
							<tr><td style="padding:0px; height:1px; background-color:#eee;" colspan="5"></td></tr>
							<?php } ?>
						</table>
					</div>
				</div>
