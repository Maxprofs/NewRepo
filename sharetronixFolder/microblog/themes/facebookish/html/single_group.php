								<div class="group">
									...
									<div class="groupinfo">
										...
										<?php }elseif( !isset($D->if_follow_group[$D->g->id])) { ?>
										...
										<?php } else { ?>
											...
											<?php if( isset($D->if_can_leave[$D->g->id]) && $D->if_can_leave[$D->g->id] == -1 ) { ?>
										...
										<div class="grouptext">
											<?= $D->g->num_followers ?> <?= $this->lang($D->g->num_followers==1?'grplist_numfollowers1':'grplist_numfollowers') ?>,<?= $D->g->num_posts ?> <?= $this->lang($D->g->num_posts==1?'grplist_numposts1':'grplist_numposts') ?>
										</div>
									</div>
								</div>