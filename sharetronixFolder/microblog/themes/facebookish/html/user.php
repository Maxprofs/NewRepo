			...
			<div id="profile2">
				...
				<?php if( $D->tab == 'updates' ) { ?>
					<div class="htabs" style="margin-bottom:6px;">
						<a href="<?= userlink($D->usr->username) ?>/tab:updates/filter:posts" class="<?= $D->filter=='posts'?'onhtab':'' ?>"><b><?= $D->filter2_title ?></b></a>
						<a href="<?= userlink($D->usr->username) ?>/tab:updates/filter:reshares" class="<?= $D->filter=='reshares'?'onhtab':'' ?>"><b><?= $D->filter5_title ?></b></a>
						<a href="<?= userlink($D->usr->username) ?>/tab:updates/filter:tweets" class="<?= $D->filter=='tweets'?'onhtab':'' ?>"><b><?= $D->filter3_title ?></b></a>
						<a href="<?= userlink($D->usr->username) ?>/tab:updates/filter:rss" class="<?= $D->filter=='rss'?'onhtab':'' ?>"><b><?= $D->filter4_title ?></b></a>
						<a href="<?= userlink($D->usr->username) ?>/tab:updates/filter:all" class="<?= $D->filter=='all'?'onhtab':'' ?>"> <b><?= $D->filter1_title ?></b></a>
					</div>
