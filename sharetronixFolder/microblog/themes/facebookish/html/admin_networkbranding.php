										...
										<td>
											<div class="radioptions">
												<label>
													...
													<b><?= $this->lang('admbrnd_frm_logo_default', array('#SITE_TITLE#'=>'Sharetronix')) ?></b>
												</label>
												...
												<div id="adm_customlogo_on" style="display: <?= $D->hdr_show_logo==2?'block':'none' ?>;">
													...
													<div class="radioptiondetails">
														...
														<div class="currentlogo" style="background-color:<?= $D->theme->logo_bgcolor ?>;">
															<img src="<?= empty($D->hdr_custom_logo) ? ($C->SITE_URL.'themes/'.$C->THEME.'/imgs/fblogo.gif') : ($C->IMG_URL.$D->hdr_custom_logo) ?>" alt="" border="0" />
														</div>
										...
										<td>
											<div class="radioptions">
												<label>
													...
													<b><?= $this->lang('admbrnd_frm_ficn_default', array('#SITE_TITLE#'=>'Sharetronix')) ?></b>
												</label>
