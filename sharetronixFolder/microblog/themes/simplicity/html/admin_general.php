									...
									<div class="greygrad3" style="padding-top:0px;">
										<form method="post" action="">
											<table id="setform" cellspacing="5">
												...
												<tr>
													<td class="setparam" valign="top"><?= $this->lang('admapistatus_val') ?></td>
													<td>
														<label style="float:left; margin-right:5px; clear:none;"><input type="radio" name="api_status" value="1" <?= $D->api_status?'checked="checked"':'' ?> /> <span><?= $this->lang('admgnrl_frm_mobi_on') ?></span></label>
														<label style="float:left; clear:none;"><input type="radio" name="api_status" value="0" <?= !$D->api_status?'checked="checked"':'' ?> /> <span><?= $this->lang('admgnrl_frm_mobi_off') ?></span></label>
													</td>
												</tr>
												<tr>
													<td class="setparam" valign="top"><?= $this->lang('admprotect_pages_name') ?></td>
													<td>
														<label style="float:left; margin-right:5px; clear:none;"><input type="radio" name="pages_protect" value="1" <?= $D->pages_protect?'checked="checked"':'' ?> /> <span><?= $this->lang('admgnrl_frm_mobi_on') ?></span></label>
														<label style="float:left; clear:none;"><input type="radio" name="pages_protect" value="0" <?= !$D->pages_protect?'checked="checked"':'' ?> /> <span><?= $this->lang('admgnrl_frm_mobi_off') ?></span></label>
													</td>
												</tr>
														...
														<div class="greygrad" style="margin-top:5px;">
															<div class="greygrad2">
																<div class="greygrad3" style="width: 400px; font-size: 10px; margin-top: 0px;">
																	<?= $this->lang('admprotect_pages_desc') ?>
																</div>
															</div>
														</div>
												...
												<tr>
													<td class="setparam" valign="top"><?= $this->lang('admgen_twit_tag') ?></td>
													<td><input type="text" name="twitter_tag" value="<?= htmlspecialchars($D->twitter_tag) ?>" class="setinp" maxlength="50" /></td>
												...
												<tr>
													...
													<td>
														<div class="greygrad" style="margin-top:5px;">
															<div class="greygrad2">
																<div class="greygrad3" style="width: 400px; font-size: 10px; margin-top: 0px;">
																	<?= $this->lang('admgen_twit_tag_desc') ?>
																</div>
															</div>
														</div>
												...
												<tr>
													<td></td>
													<td>
														<label><input type="checkbox" name="check4update" value="1" <?= $D->check4update?'checked="checked"':'' ?> /> <span><?= $this->lang('admgnrl_frm_check4update') ?></span></label>
													</td>
												</tr>
												<tr>
													<td></td>
