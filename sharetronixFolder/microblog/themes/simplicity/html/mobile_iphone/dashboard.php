		...
		<div id="postspage">	
			<div id="dropfilter">
				...
				<div id="dropmenu" style="display:none;">
					<div class="<?= $D->show=='all'?'current':'' ?>"><span><a href="<?= $C->SITE_URL ?>dashboard"><?= $this->lang('iphone_dbrd_menu_all') ?></a><strong><?= $D->tabnums['all']?('<small>'.$D->tabnums['all'].'</small>'):'' ?></strong></span></div>
					...
					<div class="<?= $D->show=='commented'?'current':'' ?>"><span><a href="<?= $C->SITE_URL ?>dashboard/show:commented"><?= $this->lang('iphone_dbrd_menu_commented') ?></a><strong><?= $D->tabnums['commented']?('<small>'.$D->tabnums['commented'].'</small>'):'' ?></strong></span></div>
					<div class="<?= $D->show=='feeds'?'current':'' ?>"><span><a href="<?= $C->SITE_URL ?>dashboard/show:feeds"><?= $this->lang('iphone_dbrd_menu_feeds') ?></a><strong><?= $D->tabnums['feeds']?('<small>'.$D->tabnums['feeds'].'</small>'):'' ?></strong></span></div>
