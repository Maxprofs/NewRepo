						...
						<div id="settings_right">
							...
							<form method="post" action="">
								...
								<table id="setform" cellspacing="5">
									...
									<tr>
										<td width="110" class="setparam"><?= $this->lang('st_cnt_s1_pemail') ?></td>
										<td><input type="text" name="personal_email" value="<?= isset($D->i->personal_email) ? htmlspecialchars($D->i->personal_email) : '' ?>" class="setinp" maxlength="255" /></td>
									</tr>
									<tr>
										<td></td>
										<td class="setparam" style="text-align:left; font-size:10px; padding:0px; padding-left:2px;"><?= $this->lang('settings_email_note') ?></td>
									</tr>
									<tr>
										<td width="110" class="setparam"><?= $this->lang('st_cnt_s1_pphone') ?></td>
										<td><input type="text" name="personal_phone" value="<?= isset($D->i->personal_phone) ? htmlspecialchars($D->i->personal_phone) : '' ?>" class="setinp" maxlength="255" /></td>
									</tr>
									<tr>
										<td width="110" class="setparam"><?= $this->lang('st_cnt_s1_wphone') ?></td>
										<td><input type="text" name="work_phone" value="<?= isset($D->i->work_phone) ? htmlspecialchars($D->i->work_phone) : '' ?>" class="setinp" maxlength="255" /></td>
									</tr>
								</table>
								<div class="ttl"><div class="ttl2">
