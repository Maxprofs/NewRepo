...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en-US">
	<head>
		...
		<link href="<?= $C->OUTSIDE_SITE_URL ?>themes/rebackgroundable/css/mobile_iphone.css" media="handheld" rel="stylesheet" type="text/css" />
		<link href="<?= $C->OUTSIDE_SITE_URL ?>themes/rebackgroundable/css/mobile_iphone.css" media="screen" rel="stylesheet" type="text/css" />
		<script type="text/javascript" src="<?= $C->OUTSIDE_SITE_URL ?>i/js/mobile_iphone.js"></script>
		...
		<link href="<?= $C->OUTSIDE_SITE_URL ?>themes/rebackgroundable/imgs/favicon.ico" type="image/x-icon" rel="shortcut icon" />
