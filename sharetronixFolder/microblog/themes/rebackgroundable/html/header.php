		...
		<div id="headline">
			<div id="headline2">
				...
				<div id="headnav">			
					...
					<a href="<?= $C->SITE_URL ?>leaders" class="<?= $this->request[0]=='leaders'?'onnav':'' ?>"><span><b><?= $this->lang('hdr_search_competitions') ?></b></span></a>
					<?php } else { ?>		 				
				...
				<?php if( $this->user->is_logged ) { ?> 				
				<div id="smallinks">
					<a href="<?= $C->SITE_URL ?>settings"><?= $this->lang('hdr_nav_settings') ?></a>				
