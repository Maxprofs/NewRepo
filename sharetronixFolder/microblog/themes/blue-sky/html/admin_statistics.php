...
?>
					<script type="text/javascript" src="<?= $C->SITE_URL ?>i/js/swfobject.js"></script>
					...
					<div id="settings">
						...
						<div id="settings_right">
							...
							<?php if( !isset($C->AUTOCHECK_FOR_UPDATE) || $C->AUTOCHECK_FOR_UPDATE==1 ) { ?>
							<div id="admin_check4update" style="display:none;">
								<?= msgbox('', '<div id="admin_check4update_txt" style="padding-top:2px; height:16px;"></div>', FALSE) ?>
							</div>
							<script type="text/javascript" src="<?= $C->SITE_URL.'themes/'.$C->THEME ?>/js/inside_admintools.js"></script>
							<script type="text/javascript"> admin_check4update(); </script>
							<?php } ?>
