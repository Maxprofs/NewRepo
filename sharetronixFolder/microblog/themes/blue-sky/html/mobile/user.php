...
?>
	...
	<?php if( $D->show == 'info' ) { ?>
		...
		<?php } ?>
	<?php }elseif( $D->num_results == 0  && (!$D->posts_protected || ($this->user->is_logged && $this->user->info->is_network_admin))) { ?>
	...
	<?php } elseif( 0 == $D->num_results ) { ?>
		<div class="msgbox" style="margin-top:10px;"><?= $this->lang('iphone_user_posts_protected', array('#USER#'=>$D->usr->username)) ?></div>
