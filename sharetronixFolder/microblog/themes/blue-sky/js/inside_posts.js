...
function reshare_post(postid, confirmmsg, msg_after)
{
	...
	req.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
	req.send("postid="+encodeURIComponent(postid)+"&type=on");
}
...
function unshare_post(postid, confirmmsg, msg_after)
{
	...
	req.open("POST", siteurl+"ajax/reshare/r:"+Math.round(Math.random()*1000), true);
	req.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
	req.send("postid="+encodeURIComponent(postid)+"&type=off");
}
...
function post_to_twitter(postid, confirmmsg, msg_after)
{
	...
	req.open("POST", siteurl+"ajax/post-to-twitter/r:"+Math.round(Math.random()*1000), true);
	req.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
	req.send("postid="+encodeURIComponent(postid));
}
...
function post_to_facebook(postid, confirmmsg, msg_after)
{
	...
	req.open("POST", siteurl+"ajax/post-to-facebook/r:"+Math.round(Math.random()*1000), true);
	req.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
	req.send("postid="+encodeURIComponent(postid));
}