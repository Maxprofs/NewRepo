  ...
  <script type="text/javascript" src="jQuery.js"></script>
          <script type="text/javascript">
            $(document).ready(function()
              {
                 var htm="<h2> <a href='product1.php?page_id=0' title='First Page'>&laquo; First</a><a href='product1.php?page_id=<?php  if($page_id==0) {echo $page_id;} else{echo $page_id-1;}?>' title='Previous Page' aria-label='Previous'>&laquo;<span aria-hidden='true'>&laquo;</span></a>";
            for(var i=1;i<='<?php echo $total_pages; ?>';i++)
            {
              htm+="<a href='product1.php?page_id="+(i-1)+"' class='number current' title="+i+">"+i+"</a>";
            }
            htm+="<a aria-label='Next' href='product1.php?page_id=<?php  echo $page_id+1;?>'  title='Next Page'>Next &raquo;<span aria-hidden='true'>&raquo;</span></a><a href='product1.php?page_id="+(i-2)+"' title='Last Page'>Last &raquo;</a></h2>";
            $(".pagination").html(htm);
              });
          </script>
