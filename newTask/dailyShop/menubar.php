<?php
 include("config.php");
 global $stmt,$conn,$category_array,$women_array,$men_array,$kids_array,$digital_array,$sports_array;
...
$sports_array=array();
 ...
 function getCategoryall()
 {
  ...
  if($execute==false)
  {
    echo "no category selected from data base";
  }
            ...
            <div class="aa-header-top-area">
              ...
              <div class="aa-header-top-right">
                <ul class="aa-head-top-nav-right">
                  ...
                  <li><a href="category_add.php"  >Category</a></li>
                </ul>
              </div>
            </div>
          </div>
